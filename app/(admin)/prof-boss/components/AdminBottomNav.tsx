"use client"
// app/(admin)/admin/components/AdminBottomNav.tsx
...
export default function AdminBottomNav() {
  ...
  return (
    <div
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#161619]/90 border-t border-white/10 backdrop-blur-xl pb-safe-bottom"
        ...
        {BOTTOM_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                color: active ? "var(--sg-gold)" : "var(--text-muted)",
              }}
            >
